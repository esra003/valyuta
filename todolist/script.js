...
listOne.style.display = listOne.children.length > 0 ? "block" : "none";}
...
listOne.innerHTML = ''; 
    ...
    const deleteButton = document.createElement('div');
        ...
        deleteButton.innerHTML = <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M1 1L9 9" stroke="#C4C4C4"/> <path d="M1 9L9 1" stroke="#C4C4C4"/></svg>;
...
sortIconReverse.addEventListener('click', function() {
    ...
    addButton.addEventListener('click', function() {
        ...
        if (inputValue !== '') {
            ...
            displayList(); 
            input.value = ''; 
            inputDiv.style.display = "none"; } else {
